...
apiURL = 'https://192.168.203.2/rest'  # Please enter your router's IP address
...
def retrieve_data_from_router_1():
    try:
        response = requests.get(apiURL + '/caps-man/interface/scan cap1',
        ...
        if response.status_code == 200:
            ...
            for entry in registration_data:
                ...
                mac_address = entry.get("addresses", "N/A")
...
while True:
    try:
        ...
        router_data1 = retrieve_data_from_router_1()
        #router_data2 = retrieve_data_from_router_1()
        #router_data3 = retrieve_data_from_router_1()

        if router_data1 is not None:
            # Insert the retrieved data into the XAMPP database
            insert_data_into_database(router_data1)
